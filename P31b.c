...
void jacobi(int nsweeps, int n, double *restrict u, double *restrict f)
{
    int i, sweep;
    double h  = 1.0 / n;
    double h2 = h*h;
    double *restrict utmp = (double*) malloc( (n+1) * sizeof(double) );
...
int main(int argc, char** argv)
{
    ...
    nsteps = (argc > 2) ? atoi(argv[2]) : 1000000;
